...
public class Constants {
	...
	public static final int TICK_AREAS_RADIUS_CHANGE = 300;//5;//2250;//362;//2100;//100;//300;//300;
	...
	public static final int SIMULATION_LENGTH =55000;//00;//( each unit represents 20seconds)
